...
% hh       = 10*ones(1,1000); % household structure
...
numIters = 10000;        	% number of iterations for Metropolis-Hastings 
saveFreq = 1000;         	% save MH output every saveFreq iterations
...
alpha = .3;             % transmission rate b/w households
